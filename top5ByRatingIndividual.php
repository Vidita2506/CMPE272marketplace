...
<body>
    ...
    <header id="header">
        <div class="container">
            ...
            <ul>
              <li><a href="lastvisitedpages.php">Top 5 products by Rating (<?php echo $companyName?>)</a></li>
    ...
    <section id="about" style="">
        ...
        <div class="container about-container wow fadeInUp">
            ...
            <div class="col-md-6">
                <div class="col-md-3 about-img">
                    <img  src=<?php echo $productimage[0] ?> alt="">
                </div>
                ...
                <div class="col-md-8 about-content">
                    ...
                    <p
                        style="font-weight:900;padding-top:0;padding-bottom:0;margin-top:0;margin-bottom:0;color:#03C4EB;font-size:15px">
                        Average Rating : <span style="color:black;font-weight:900"><?php echo $average[0] ?></span> </p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="col-md-3 about-img">
                    <img src=<?php echo $productimage[1] ?> alt="">
                </div>
                ...
                <div class="col-md-8 about-content">
                    ...
                    <p
                        style="font-weight:900;padding-top:0;padding-bottom:0;margin-top:0;margin-bottom:0;color:#03C4EB;font-size:15px">
                        Average Rating : <span style="color:black;font-weight:900"><?php echo $average[1] ?></span> </p>
                </div>
            </div>
            </div>
        </div>
        ...
        <div class="container about-container wow fadeInUp">
            ...
            <div class="col-md-6">
                <div class="col-md-3 about-img">
                    <img src=<?php echo $productimage[2] ?> alt="">
                </div>
                ...
                <div class="col-md-8 about-content">
                    ...
                    <p
                        style="font-weight:900;padding-top:0;padding-bottom:0;margin-top:0;margin-bottom:0;color:#03C4EB;font-size:15px">
                        Average Rating : <span style="color:black;font-weight:900"><?php echo $average[2] ?></span> </p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="col-md-3 about-img">
                    <img src=<?php echo $productimage[3] ?> alt="">
                </div>
                ...
                <div class="col-md-8 about-content">
                    ...
                    <p
                        style="font-weight:900;padding-top:0;padding-bottom:0;margin-top:0;margin-bottom:0;color:#03C4EB;font-size:15px">
                        Average Rating : <span style="color:black;font-weight:900"><?php echo $average[3] ?></span> </p>
                </div>
            </div>
            </div>
        </div>
        <div class="container about-container wow fadeInUp">
            ...
            <div class="col-md-6">
                <div class="col-md-3 about-img">
                    <img src=<?php echo $productimage[4] ?> alt="">
                </div>
                ...
                <div class="col-md-8 about-content">
                    ...
                    <p
                        style="font-weight:900;padding-top:0;padding-bottom:0;margin-top:0;margin-bottom:0;color:#03C4EB;font-size:15px">
                        Average Rating : <span style="color:black;font-weight:900"><?php echo $average[4] ?></span> </p>
                </div>
            </div>
