  ...
  <section id="hero">
    <div class="hero-container">
      <div class="wow fadeIn">
        ...
        <h2>Our companies are <span class="rotating" style="color:red;">Fitness Studio, PPM Software Solution, Arcade Motor Services, Bookszon, VR Grad, Platinum County Gym</span></h2>
    ...
    <div class="container wow fadeInUp">
      ...
      <div class="row">
        ...
        <div class="col-md-4 service-item">
          ...
          <h4 class="service-title"><a href="showProducts.php?website_id=1">Bookzon</a></h4>
          <p class="service-description">Buy the best books at best price</p>
        </div>
        <div class="col-md-4 service-item">
          <div class="service-icon"><i class="fa fa-paper-plane"></i></div>
          <h4 class="service-title"><a href="showProducts.php?website_id=2">VR GRAD</a></h4>
        ...
        <div class="col-md-4 service-item">
          ...
          <h4 class="service-title"><a href="showProducts.php?website_id=4">Arcade Motor Services</a></h4>
